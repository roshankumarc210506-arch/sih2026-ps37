...
egoVehicle = vehicle(scenario, ...
    'ClassID',   double(AgentClass.Car), ...
    'Name',      'Ego', ...
    'Length', 4.2, 'Width', 1.8, 'Height', 1.5, 'Wheelbase', 2.5, ...
    'Position',  [0 -1.5 0]);
smoothTrajectory(egoVehicle, roadCenters + [0 -1.5 0], 8);

% ---------------- 1. Oncoming car ----------------
a = vehicle(scenario, 'ClassID', double(AgentClass.Car), 'Name','OncomingCar', ...
...
a = actor(scenario, 'ClassID', double(AgentClass.AutoRickshaw), 'Name','AutoRickshaw', ...
    'Length',2.6,'Width',1.4,'Height',1.7,'Position',[38 -1.4 0]);
...
a = actor(scenario, 'ClassID', double(AgentClass.PushCart), 'Name','PushCart', ...
...
a = actor(scenario, 'ClassID', double(AgentClass.Pedestrian), 'Name','Pedestrian', ...
...
a = actor(scenario, 'ClassID', double(AgentClass.Animal), 'Name','Cow', ...
...
a = actor(scenario, 'ClassID', double(AgentClass.Pedestrian), 'Name','Pedestrian2', ...
